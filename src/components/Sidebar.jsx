...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col fixed left-0 top-0 h-screen w-64 bg-white border-r border-slate-200 shadow-sm">
      {/* Header */}
      <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-200">
        <NetthexMark />
        <span className="font-bold text-lg text-slate-900">Netthex</span>
      </div>
